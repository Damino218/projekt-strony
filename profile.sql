...
--
-- Host: 127.0.0.1
-- Czas generowania: 21 Lut 2024, 16:47
...
--
-- Struktura tabeli dla tabeli `profile_type`
--
...
--
-- Indeksy dla tabeli `profile_type`
--
...
--
-- AUTO_INCREMENT dla tabeli `profile_type`
--
ALTER TABLE `profile_type`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Ograniczenia dla tabeli `profile_type`
--
ALTER TABLE `profile_type`
  ADD CONSTRAINT `profile_type_ibfk_1` FOREIGN KEY (`profileID`) REFERENCES `profile` (`ID`);
COMMIT;
